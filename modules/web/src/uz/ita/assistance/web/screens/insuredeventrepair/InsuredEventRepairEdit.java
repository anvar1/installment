package uz.ita.assistance.web.screens.insuredeventrepair;
...
@UiController("assistance_InsuredEventRepair.edit")
@UiDescriptor("insured-event-repair-edit.xml")
@EditedEntityContainer("insuredEventRepairDc")
@LoadDataBeforeShow
public class InsuredEventRepairEdit extends StandardEditor<InsuredEventRepair> {
