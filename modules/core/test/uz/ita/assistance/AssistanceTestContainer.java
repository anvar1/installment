...
public class AssistanceTestContainer extends TestContainer {

    public AssistanceTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "uz/ita/assistance/app.properties",
    ...
    public static class Common extends AssistanceTestContainer {

        public static final AssistanceTestContainer.Common INSTANCE = new AssistanceTestContainer.Common();
