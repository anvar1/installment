...
@NamePattern("%s|id")
@Table(name = "ASSISTANCE_INSURED_EVENT_REPAIR_NOT_COVERED")
@Entity(name = "assistance_InsuredEventRepairNotCovered")
public class InsuredEventRepairNotCovered extends BaseLongIdEntity {
    private static final long serialVersionUID = 7394105177437005636L;
